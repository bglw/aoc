    ...
    def test_split(self):
        ...
        expected = dedent("""
            ...
            [Z] [M] [P]
             1   2   3 
        """).lstrip().rstrip()
        self.assertEqual(split_board(data)[0], expected + " ")
        self.assertEqual(split_board(data)[1][0], "move 1 from 2 to 1")
